...
<html lang="en">
<head>
	<title>Nasi Goreng Cina Detail</title>
	<meta charset="UTF-8">
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/ngcina.jpg">
							<div class="wrap-pic-w">
								<img src="images/ngcina.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/ngcina1.jpg">
							<div class="wrap-pic-w">
								<img src="images/ngcina1.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/ngcina2.jpg">
							<div class="wrap-pic-w">
								<img src="images/ngcina2.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
							Chinese fried rice have basic use of the rattan. In addition to the common sauteed ingredients, onion, it is found that the Chinese fried rice is cooked using liquid soy sauce , fish stock , sesame oil , ginger or other ingredients commonly used in chinese cuisine . Eggs are also part of a typical roast for chinese fried rice.
						</p>
					</div>
				</div>
