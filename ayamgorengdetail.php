...
<html lang="en">
<head>
	<title>Ayam Goreng Detail</title>
	<meta charset="UTF-8">
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/ayamgoreng.jpg">
							<div class="wrap-pic-w">
								<img src="images/ayamgoreng.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/ayamgoreng1.jpg">
							<div class="wrap-pic-w">
								<img src="images/ayamgoreng1.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/ayamgoreng2.jpg">
							<div class="wrap-pic-w">
								<img src="images/ayamgoreng2.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
							1 pcs of delicious fried chicken.
					</div>
				</div>
