...
<html lang="en">
<head>
	<title>Nasi Goreng USA Detail</title>
	<meta charset="UTF-8">
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/ngusa.jpg">
							<div class="wrap-pic-w">
								<img src="images/ngusa.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/ngusa1.jpg">
							<div class="wrap-pic-w">
								<img src="images/ngusa1.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/ngusa2.jpg">
							<div class="wrap-pic-w">
								<img src="images/ngusa2.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
							Fried Rice USA stands for Fried Rice, Squid and Chicken . The use of "USA" refers to the substance used, namely shrimp, squid and chicken.
							The basic ingredients for this dish are to use fried rice. Typically, the fried rice is simply a seasoned ingredient, such as onions , sauces, and some vegetables . 
							However, the use of shrimp, octopus and chicken in a dish that distinguishes this fried rice with other fried rice.
					</div>
				</div>
