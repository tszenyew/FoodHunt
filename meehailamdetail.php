		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/meehailam.jpg">
							<div class="wrap-pic-w">
								<img src="images/meehailam.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/meehailam1.jpg">
							<div class="wrap-pic-w">
								<img src="images/meehailam1.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/meehailam2.jpg">
							<div class="wrap-pic-w">
								<img src="images/meehailam2.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
							This noodle dish differ from the rest as it has vegetables . The vegetables plus the chicken meat and prawns gives a combined flavour to the dish which makes it stand out compare to the rest of the dishes.
					</div>
				</div>
							...
							<!-- Block2 -->
								<div class="block2">
									...
									<div class="block2-txt p-t-20">
										<a href="meebandungdetail.html" class="block2-name dis-block s-text3 p-b-5">
