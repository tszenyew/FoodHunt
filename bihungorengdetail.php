...
<html lang="en">
<head>
	<title>Bihun Goreng Detail</title>
	<meta charset="UTF-8">
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/bihungoreng.jpg">
							<div class="wrap-pic-w">
								<img src="images/bihungoreng.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/bihungoreng1.jpg">
							<div class="wrap-pic-w">
								<img src="images/bihungoreng1.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/bihungoreng2.jpg">
							<div class="wrap-pic-w">
								<img src="images/bihungoreng2.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
							 It is made with thin yellow noodles fried in cooking oil with garlic, onion or shallots, fried prawn,octopus, chicken,  or sliced of meatballs, chili, Chinese cabbage, cabbages, tomatoes, egg, and other vegetables.
					</div>
				</div>
				            ...
				            <div class="btn-addcart w-size1 trans-0-4">  
												<!-- Button -->
												<button class="flex-c-m size1 bg4 bo-rad-23 hov1 s-text1 trans-0-4" onclick="simpleCart.add({name:'Bihun Goreng', price: 5.00,size:'tiny',thumb:'images/bihungoreng.jpg'});">
													Add to Cart
												</button>
							</div>
