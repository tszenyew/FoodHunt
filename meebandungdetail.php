...
<html lang="en">
<head>
	<title>Mee Bandung Detail</title>
	<meta charset="UTF-8">
		...
		<div class="flex-w flex-sb">
			<div class="w-size13 p-t-30 respon5">
				<div class="wrap-slick3 flex-sb flex-w">
					...
					<div class="slick3">
						<div class="item-slick3" data-thumb="images/meebandung.jpg">
							<div class="wrap-pic-w">
								<img src="images/meebandung.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/meebandung1.jpg">
							<div class="wrap-pic-w">
								<img src="images/meebandung1.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>

						<div class="item-slick3" data-thumb="images/meebandung2.jpg">
							<div class="wrap-pic-w">
								<img src="images/meebandung2.jpg" alt="IMG-PRODUCT" width="200" height="350">
							</div>
						</div>
					</div>
				</div>
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="wrap-dropdown-content bo6 p-t-15 p-b-14 active-dropdown-content">
					...
					<div class="dropdown-content dis-none p-t-15 p-b-23">
						<p class="s-text8">
						Mee bandung is a cuisine that originally consisted only of noodles and eggs in addition to a soup made of a mixture of chilli, onion, spices, shrimp paste and dried shrimp. 
						Later it was improved by the addition of shrimp, meat, fish cakes and vegetables.
					</div>
				</div>
			 ...
			 <div class="item-slick2 p-l-15 p-r-15">
							<div class="block2">
									...
									<div class="block2-txt p-t-20">
										<a href="meegorengdetail.html" class="block2-name dis-block s-text3 p-b-5">
					...
					<div class="item-slick2 p-l-15 p-r-15">
						<!-- Block2 -->
								<div class="block2">
									...
									<div class="block2-txt p-t-20">
										<a href="meehailamdetail.html" class="block2-name dis-block s-text3 p-b-5">
